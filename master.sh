...
# Exécution du fichier script avec "./master.sh"
# Céation d'une variable "nom_variable=valeur"
# Affichage de la variable avec "echo $nom_variable"
master_syscom="HelloEmbeddedLinux"
echo $master_syscom
